          Shader "ExampleShader"
{
    ...
    SubShader
    {
        Pass
        {
            ...
            float _Scale, _DisplacementAmplitude;
            ...
            v2f vert(appdata_base v, uint svInstanceID : SV_InstanceID)
            {
                ...
                float4 wpos = mul(_ObjectToWorld, RotateAroundYInDegrees(float4(v.vertex.x * _Scale + displacement.x, v.vertex.y * _Scale, v.vertex.z + displacement.y, v.vertex.w), posHash * 180.0f) + pos);
