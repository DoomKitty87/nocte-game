...
public class WorldGenerator : MonoBehaviour
{
    ...
    private void GenerateTile(int x, int z, int index)
    {
        ...
        Mesh msh = mf.mesh;
        int seed = _seed;
        Vector3[] vertexData = NoiseMaps.GenerateTerrainLayers(x * _xSize * _xResolution + seed, z * _zSize * _zResolution + seed, _xSize, _zSize, _biomes[0].noiseLayers, _xResolution, _zResolution);
    ...
    private void UpdateTile(int index) {
        ...
        int seed = _seed;
        _tilePool[index].mesh.vertices = NoiseMaps.GenerateTerrainLayers(x * _xSize * _xResolution + seed, z * _zSize * _zResolution + seed, _xSize, _zSize, _biomes[0].noiseLayers, _xResolution, _zResolution);
